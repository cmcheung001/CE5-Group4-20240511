...
resource "aws_ecs_task_definition" "own_task_definition" {
  ...
  #   image_url        = "255945442255.dkr.ecr.us-east-1.amazonaws.com/jeremy-test-ecr-repo:latest"
  #   container_name   = "jeremy-test-ecs"
  #   port_name        = "jeremy-test-ecs-8080-tcp"
  #   log_group_region = "us-east-1"
  #   log_group_name   = "/ecs/jeremytesttaskdef"
  ...
  container_definitions = templatefile("./files/ecr-task-definition.json", {
    ...
    # use spring image
    image_url        = "springcommunity/spring-framework-petclinic:latest"
